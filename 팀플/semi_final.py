...
def process_image(image_path, distance_threshold):
    ...
    for roi, (x, y) in roi_list:
        ...
        for preprocess_func in preprocessing_functions:
            ...
            if preprocess_func is preprocess_4:
                ...
                circles = detect_cotton_swabs(roi, preprocessed, 25, 37, 35, 28, roi_mask)
    ...
    # 결과 이미지에 면봉 개수 출력
    image = Put_Korean_Text(image, f"Count: {total_cotton_swabs}", (30, 60), 80, (0, 255, 255))
